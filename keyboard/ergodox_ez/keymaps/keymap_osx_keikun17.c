 ...
 * |--------+------+------+------+------+------| Hyper|           | Meh  |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |V/LAlt|   B  |      |           |      |   N  |M/LAlt|   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,        CTL_T(KC_Z),  KC_X,          KC_C,     ALT_T(KC_V), KC_B,        ALL_T(KC_NO),
        ...
        MEH_T(KC_NO),   KC_N,         ALT_T(KC_M),   KC_COMM,  KC_DOT,      CTL_T(KC_SLSH),     KC_RSFT,
